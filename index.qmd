...
For randomization, the other predictor is marital status but the greatest effect is whether data is missing – does this reflect cooperation of the patient? The predictive power of this model is quite strong (AUC 0.78, linear calibration curve).
